...
field_values={...
	...
	(md.results.TransientSolution(end).SmbTs(1)),...
	(md.results.TransientSolution(end).SmbT10(1)),...
	(md.results.TransientSolution(end).SmbT30(1)),...
	(md.results.TransientSolution(end).SmbT50(1)),...
